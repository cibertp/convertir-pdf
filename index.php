	...
	<form method="post">
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username="poeta462@gmail.com";//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword="264poeta";//Tu contraseña de gmail
				$mail_addAddress="melaniorhg@gmail.com";//correo electronico que recibira el mensaje
				$template="email_template.php";//Ruta de la plantilla HTML para enviar nuestro mensaje
